...
def showCategory(category_id):
    ...
    if 'user_id' not in login_session or login_session['user_id'] != creator.id:
        return render_template('public_category.html', items = items, category = category, creator= creator)
    else:
...
def newCategory():
    ...
    if request.method == 'POST':
        newCategory = Category(name = request.form['name'], created_by = login_session['user_id'])
...
def newItem(category_id):
  ...
  if category.created_by != login_session['user_id']:
      return "<script>function myFunction() {alert('You are not authorized to create new item for this category');}</script><body onload='myFunction()'>"
  if request.method == 'POST':
      newItem = Item(name = request.form['name'], description = request.form['description'], category_id = category_id, created_by = login_session['user_id'])
      session.add(newItem)
      session.commit()
...
def editItem(category_id, item_id):
    ...
    if editedItem.created_by != login_session['user_id']:
        return "<script>function myFunction() {alert('You are not authorized to edit item for this category');}</script><body onload='myFunction()'>"
    if request.method == 'POST':
        if request.form['name']:
...
def deleteItem(category_id, item_id):
    ...
    if itemToDelete.created_by != login_session['user_id']:
        return "<script>function myFunction() {alert('You are not authorized to delete item for this category');}</script><body onload='myFunction()'>"
    if request.method == 'POST':
